...
# Teste pull - João Gabril Bisco (Testar pull request)
...
class PerfilService:
    ...
    def cadastrar(self, perfil: Perfil):
        ...
        for perfil_existente in perfis:
            ...
            desc = perfil_existente.get('ds_perfil') if isinstance(perfil_existente, dict) else getattr(perfil_existente, 'ds', None)
