...
from controllers.usuario_controllers import router as usuario_router

# Importa o Controller de perfis.
from controllers.perfil_controllers import router as perfil_router
...
app = FastAPI(
    title="Patinhas API",
    description="API do sistema Patinhas",
    version="1.0.0"
)
...
def inicio():
    ...
    return {
        "mensagem": "API Patinhas funcionando!"
    }
