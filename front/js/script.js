...
function mostrarMensagem() {
    ...
    showToast('Sistema Patinhas Saudáveis está funcionando!', 'info');
}
...
function toggleTheme(){
    const isDark = document.documentElement.classList.toggle('dark');
    localStorage.setItem('patinhas-theme', isDark ? 'dark' : 'light');
}

// Aplica o tema salvo anteriormente (ou o padrão claro).
function aplicarTemaSalvo(){
    const tema = localStorage.getItem('patinhas-theme');
    if (tema === 'dark') document.documentElement.classList.add('dark');
}
